...
- Go 1.27+
- Node.js 24 LTS
- Wails v3 CLI, the same version as the module in `go.mod` (CI's bindings-drift check uses it): `go install github.com/wailsapp/wails/v3/cmd/wails3@v3.0.0-beta.25`
